        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="collapse navbar-collapse d-flex justify-content-center align-items-center" id="navbarNavAltMarkup">
             <marquee width="100%" direction="center" behavior="alternate" ><span style="font-size:35px;font-weight:bold;color:Black;font-family:'Helvetica', cursive;">Leave Management System</span>
        </marquee>
