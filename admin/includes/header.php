        ...
        <div class="mn-content fixed-sidebar">
            <header class="mn-header navbar-fixed">
                ...
                <nav class="navbar navbar-expand-lg navbar-light py-3 " >
                  ...
                  <marquee width="950px" direction="left" behavior="alternate" ><span style="font-size:35px; width=''font-weight:bold; color:Black;font-family:'Hevetica', cursive;">Leave Management System</span>
        </marquee>
